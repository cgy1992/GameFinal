...
{	
	...
	float4 c1 = GF_TEXTURE_0.Sample(gSampleState, pin.Tex);
	float4 c2 = GF_TEXTURE_1.Sample(gSampleState, pin.Tex * 0.372f);
	...
	return GF_AMBIENT * GF_MTRL_AMBIENT * texColor
		+ GF_MTRL_EMISSIVE + diffuse * GF_MTRL_DIFFUSE * shadowFactor * texColor
