...
typedef unsigned int HKG_PAD_CONNECTED_MASK;
#define HKG_PAD_CONNECTED_NONE 0
#define HKG_PAD_CONNECTED_0 1
#define HKG_PAD_CONNECTED_1 2
#define HKG_PAD_CONNECTED_2 4
#define HKG_PAD_CONNECTED_3 8
